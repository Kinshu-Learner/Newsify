...
export default class Newsitem extends Component {
    render() {
        let { title, description, urlToImage, author, publishedAt, source } = this.props
        return (
            <div>
                <div className="card my-3" style={{ width: "20rem", height: "31rem"}}>
                    ...
                    <div className="card-body text-center">
                        ...
                        <a href={this.props.url} target='_blank' rel="noopener noreferrer" className="btn btn-danger btn-sm">Read More</a>
                    </div>
                </div>
            </div>
        )
